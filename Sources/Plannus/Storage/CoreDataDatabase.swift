...
/// (re)generated on insert and coerced to strings.
public final class CoreDataDatabase: TaskDatabase {
    ...
    public init(inMemory: Bool = false) throws {
        ...
        if let loadError { throw PlannusError.database("Failed to load store: \(loadError)") }
    ...
    private func saveContext() throws {
        ...
        do { try context.save() } catch { throw PlannusError.database("Save failed: \(error)") }
    }
